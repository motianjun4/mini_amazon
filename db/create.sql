...
(
    id integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    pid integer NOT NULL REFERENCES "product" (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "cart" (
    id INT NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    uid INT NOT NULL REFERENCES "user" (id) ON DELETE CASCADE,
    iid INT NOT NULL REFERENCES "inventory" (id) ON DELETE CASCADE,
...
(
    id integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    oid integer NOT NULL REFERENCES "order" (id) ON DELETE CASCADE,
    iid integer NOT NULL REFERENCES "inventory" (id) ON DELETE CASCADE,
    price decimal(14,2) NOT NULL,
...
(
    id integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    rid integer NOT NULL REFERENCES "review" (id) ON DELETE CASCADE,
    uid integer NOT NULL REFERENCES "user" (id) ON DELETE CASCADE,
